  ...
  return function IconComponent({ color, focused }: { color: ColorValue; focused: boolean }) {
    ...
    return (
      <View style={{ paddingHorizontal: 12, paddingVertical: 4, alignItems: "center", marginBottom: 4, justifyContent: "center" }}>
        <Animated.View
          style={[
            { position: "absolute", top: 0, left: 0, right: 0, bottom: 0, backgroundColor: "#F5F3FF", borderRadius: 99 },
            pillStyle,
          ]}
        />
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen
        ...
        options={{
          title: "Data",
          tabBarIcon: ActiveTabIcon("grid-outline", "grid", ["/announcements", "/schedules", "/inquiries", "/log-inquiry", "/materials", "/post-material", "/material-detail", "/attendance", "/timetable-editor", "/exam-editor", "/teaching-plans", "/teaching-plan-editor", "/teaching-plan-detail", "/sessions", "/fees", "/fee-detail", "/fee-structures"]),
        }}
      />
