  ...
  return (
    <View style={{ flex: 1, backgroundColor: D.bg }}>
      ...
      >
        ...
        {/* Profile hero — gradient avatar matching student portal */}
        <View style={s.profileBlock}>
          <View style={s.avatarWrap}>
            <LinearGradient colors={[D.primaryBtn, "#8B5CF6"]} style={s.avatarCircle} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }}>
          ...
          <View style={s.profileInfo}>
            ...
            <View style={s.profileRoleRow}>
              <View style={s.roleChip}>
                <Text style={s.roleChipText}>Head Teacher</Text>
              </View>
            </View>
        ...
        <View style={s.grid2}>
          {[
            { label: "Batches", value: String((profile as any)?.teacherClassNames?.length ?? "—") },
            { label: "Subjects", value: String((profile as any)?.teacherSubjectNames?.length ?? "—") },
          ].map((stat) => (
...
const s = StyleSheet.create({
  ...
  editBtn: { width: 32, height: 32, borderRadius: 8, backgroundColor: D.surfaceLow, borderWidth: 1, borderColor: D.surfaceHigh, alignItems: "center", justifyContent: "center", marginTop: 2 },
  ...
  signOutBtn: { marginBottom: 18, padding: 14, borderRadius: 14, backgroundColor: D.errorBg, alignItems: "center" },
  signOutText: { fontSize: 14, fontWeight: "700", color: D.errorFg, fontFamily: D.fontBold },
