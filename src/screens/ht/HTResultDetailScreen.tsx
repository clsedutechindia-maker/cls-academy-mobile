...
export function HTResultDetailScreen() {
  ...
  const passing = sorted.filter((r) => r.maxScore > 0 && (r.score / r.maxScore) >= 0.6).length;
          ...
          <>
            ...
            <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
              ...
              <View style={s.sortToggle}>
                <View style={[s.sortBtn, s.sortBtnActive]}>
                  <Text style={[s.sortText, { color: D.primary }]}>By Marks</Text>
                </View>
              </View>
            </View>
