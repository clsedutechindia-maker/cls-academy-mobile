...
const s = StyleSheet.create({
  ...
  segText: { fontSize: 11, fontFamily: D.fontSemiBold, letterSpacing: -0.1 },
  dayChip: { flex: 1, paddingVertical: 9, borderRadius: 10, alignItems: "center", borderWidth: 1 },
  dayText: { fontSize: 12, fontFamily: D.fontSemiBold },
  sectionLabel: { fontSize: 11, fontFamily: D.fontSemiBold, color: D.outline, letterSpacing: 0.6, marginBottom: 14 },
  ...
  slotTime: { fontSize: 11.5, fontFamily: D.fontSemiBold, color: D.onSurface, letterSpacing: -0.2 },
  ...
  slotSubjectTag: { fontSize: 9, fontFamily: D.fontSemiBold, letterSpacing: 0.5, marginBottom: 3 },
  slotSubject: { fontSize: 12.5, fontFamily: D.fontMedium, color: D.onSurface, letterSpacing: -0.1 },
  ...
  datePillMon: { fontSize: 9, fontFamily: D.fontSemiBold, letterSpacing: 0.4, textTransform: "uppercase" },
  datePillDay: { fontSize: 16, fontFamily: D.fontSemiBold, letterSpacing: -0.4, lineHeight: 20 },
  subjInline: { fontSize: 9, fontFamily: D.fontSemiBold, letterSpacing: 0.5, marginBottom: 3 },
  examName: { fontSize: 13, fontFamily: D.fontMedium, color: D.onSurface, letterSpacing: -0.1 },
  examBatch: { fontSize: 11, fontFamily: D.font, color: D.outline, marginTop: 2 },
  daysLeft: { fontSize: 12, fontFamily: D.fontSemiBold, flexShrink: 0 },
});
