...
export const DEMO_PROFILES: Record<DemoRole, UserProfileRecord> = {
  ...
  class_teacher: {
    ...
    centreName: CENTRE_NAME,
    branch: "",
    teacherId: "CLS-T-0012",
    teacherRole: "class_teacher",
    teacher_role: "class_teacher",
    teacherClassIds: [CLASS_ID_11B],
    teacherClassNames: [CLASS_NAME_11B],
    teacherSubjectIds: ["demo-sub-chemistry"],
    teacherSubjectNames: ["Chemistry"],
    teacher_class_ids: [CLASS_ID_11B],
    teacher_class_names: [CLASS_NAME_11B],
    teacher_subject_ids: ["demo-sub-chemistry"],
    teacher_subject_names: ["Chemistry"],
    employeeId: "",
    employee_id: "",
    employeeType: "",
    employeeCompetitiveExam: "",
